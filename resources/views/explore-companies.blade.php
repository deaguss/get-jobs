        ...
        <div class="overflow-x-auto">
            <div class="inline-flex space-x-4">
                ...
                <div class="flex-shrink-0 max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow w-80">
                    ...
                    <a href="#" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-[#051A49] rounded-lg focus:ring-4 focus:outline-none focus:ring-blue-300">
                        See Jobs
